...
namespace PlayWay.Water
{
	public class WaterWavesSpectrumData
	{
		...
		[CompilerGenerated]
		private static Comparison<WaterWave> _003C_003Ef__am_0024cache0;
		...
		public void SortCpuWaves(WaterWave[] windWaves, bool mostlySorted)
		{
			if (!mostlySorted)
			{
				...
				{
					_003C_003Ef__am_0024cache0 = _003CSortCpuWaves_003Em__0;
				}
				Array.Sort(windWaves, _003C_003Ef__am_0024cache0);
				return;
			}
		...
		[CompilerGenerated]
		private static int _003CSortCpuWaves_003Em__0(WaterWave a, WaterWave b)
		{
			if (a.cpuPriority > b.cpuPriority)
			{
				return -1;
			}
			return (a.cpuPriority != b.cpuPriority) ? 1 : 0;
		}
	}
}
