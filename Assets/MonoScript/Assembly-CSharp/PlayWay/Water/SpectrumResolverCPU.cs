...
namespace PlayWay.Water
{
	public class SpectrumResolverCPU
	{
		...
		[CompilerGenerated]
		private sealed class _003CGetDisplacementAt_003Ec__AnonStorey0
		{
			internal float x;
			...
			internal Vector3 result;

			internal void _003C_003Em__0(WaterWave[] cpuWaves, int startIndex, int endIndex)
			{
				Vector3 vector = default(Vector3);
				for (int i = startIndex; i < endIndex; i++)
				{
					vector += cpuWaves[i].GetDisplacementAt(x, z, time);
				}
				result += vector;
			}
		}
		...
		[CompilerGenerated]
		private sealed class _003CGetHorizontalDisplacementAt_003Ec__AnonStorey1
		{
			internal float x;
		...
		[CompilerGenerated]
		private sealed class _003CGetForceAndHeightAt_003Ec__AnonStorey2
		{
			internal float x;
			...
			internal void _003C_003Em__0(WaterWave[] cpuWaves, int startIndex, int endIndex)
			{
				...
				for (int i = startIndex; i < endIndex; i++)
				{
					cpuWaves[i].GetForceAndHeightAt(x, z, time, ref vector);
				}
				result += vector;
			}
		}
		...
		[CompilerGenerated]
		private sealed class _003CGetHeightAt_003Ec__AnonStorey3
		{
			internal float x;
			...
			internal void _003C_003Em__0(WaterWave[] cpuWaves, int startIndex, int endIndex)
			{
				...
				for (int i = startIndex; i < endIndex; i++)
				{
					num += cpuWaves[i].GetHeightAt(x, z, time);
				}
				result += num;
			}
		}
		...
		[CompilerGenerated]
		private static Comparison<FoundWave> _003C_003Ef__am_0024cache0;

		[CompilerGenerated]
		private static Comparison<FoundWave> _003C_003Ef__am_0024cache1;

		[CompilerGenerated]
		private static Comparison<FoundWave> _003C_003Ef__am_0024cache2;
		...
		{
			_003CGetDisplacementAt_003Ec__AnonStorey0 _003CGetDisplacementAt_003Ec__AnonStorey = new _003CGetDisplacementAt_003Ec__AnonStorey0();
			_003CGetDisplacementAt_003Ec__AnonStorey.x = x;
			_003CGetDisplacementAt_003Ec__AnonStorey.z = z;
			_003CGetDisplacementAt_003Ec__AnonStorey.time = time;
			_003CGetDisplacementAt_003Ec__AnonStorey.result = default(Vector3);
			_003CGetDisplacementAt_003Ec__AnonStorey.x = 0f - (_003CGetDisplacementAt_003Ec__AnonStorey.x + surfaceOffset.x);
			_003CGetDisplacementAt_003Ec__AnonStorey.z = 0f - (_003CGetDisplacementAt_003Ec__AnonStorey.z + surfaceOffset.y);
			if (spectrumStart == 0f)
			{
				for (int num = numTiles - 1; num >= 0; num--)
				{
					if (tileSpectra[num].resolveByFFT)
					{
						...
						{
							InterpolationParams(_003CGetDisplacementAt_003Ec__AnonStorey.x, _003CGetDisplacementAt_003Ec__AnonStorey.z, num, windWaves.TileSizes[num], out fx, out invFx, out fy, out invFy, out index, out index2, out index3, out index4);
							tileSpectra[num].GetResults(_003CGetDisplacementAt_003Ec__AnonStorey.time, out da, out db, out fa, out fb, out p);
						}
						...
						_003CGetDisplacementAt_003Ec__AnonStorey.result.x -= vector.x;
						_003CGetDisplacementAt_003Ec__AnonStorey.result.z -= vector.y;
						_003CGetDisplacementAt_003Ec__AnonStorey.result.y += FastMath.Interpolate(fa[index].w, fa[index2].w, fa[index3].w, fa[index4].w, fb[index].w, fb[index2].w, fb[index3].w, fb[index4].w, fx, invFx, fy, invFy, p);
					}
				}
			}
			if (filteredCpuWavesCount != 0)
			{
				SampleWavesDirectly(spectrumStart, spectrumEnd, _003CGetDisplacementAt_003Ec__AnonStorey._003C_003Em__0);
			}
			float num2 = (0f - water.HorizontalDisplacementScale) * uniformWaterScale;
			_003CGetDisplacementAt_003Ec__AnonStorey.result.x = _003CGetDisplacementAt_003Ec__AnonStorey.result.x * num2;
			_003CGetDisplacementAt_003Ec__AnonStorey.result.y *= uniformWaterScale;
			_003CGetDisplacementAt_003Ec__AnonStorey.result.z = _003CGetDisplacementAt_003Ec__AnonStorey.result.z * num2;
			return _003CGetDisplacementAt_003Ec__AnonStorey.result;
		}

		public Vector2 GetHorizontalDisplacementAt(float x, float z, float spectrumStart, float spectrumEnd, float time)
		{
			_003CGetHorizontalDisplacementAt_003Ec__AnonStorey1 _003CGetHorizontalDisplacementAt_003Ec__AnonStorey = new _003CGetHorizontalDisplacementAt_003Ec__AnonStorey1();
			_003CGetHorizontalDisplacementAt_003Ec__AnonStorey.x = x;
			_003CGetHorizontalDisplacementAt_003Ec__AnonStorey.z = z;
			_003CGetHorizontalDisplacementAt_003Ec__AnonStorey.time = time;
			_003CGetHorizontalDisplacementAt_003Ec__AnonStorey.result = default(Vector2);
			_003CGetHorizontalDisplacementAt_003Ec__AnonStorey.x = 0f - (_003CGetHorizontalDisplacementAt_003Ec__AnonStorey.x + surfaceOffset.x);
			_003CGetHorizontalDisplacementAt_003Ec__AnonStorey.z = 0f - (_003CGetHorizontalDisplacementAt_003Ec__AnonStorey.z + surfaceOffset.y);
			if (spectrumStart == 0f)
			{
				for (int num = numTiles - 1; num >= 0; num--)
				{
					if (tileSpectra[num].resolveByFFT)
					{
						...
						lock (tileSpectra[num])
						{
							InterpolationParams(_003CGetHorizontalDisplacementAt_003Ec__AnonStorey.x, _003CGetHorizontalDisplacementAt_003Ec__AnonStorey.z, num, windWaves.TileSizes[num], out fx, out invFx, out fy, out invFy, out index, out index2, out index3, out index4);
							Vector4[] fa;
							Vector4[] fb;
							tileSpectra[num].GetResults(_003CGetHorizontalDisplacementAt_003Ec__AnonStorey.time, out da, out db, out fa, out fb, out p);
						}
						_003CGetHorizontalDisplacementAt_003Ec__AnonStorey.result -= FastMath.Interpolate(ref da[index], ref da[index2], ref da[index3], ref da[index4], ref db[index], ref db[index2], ref db[index3], ref db[index4], fx, invFx, fy, invFy, p);
					}
				}
			}
			if (filteredCpuWavesCount != 0)
			{
				SampleWavesDirectly(spectrumStart, spectrumEnd, _003CGetHorizontalDisplacementAt_003Ec__AnonStorey._003C_003Em__0);
			}
			float num2 = (0f - water.HorizontalDisplacementScale) * uniformWaterScale;
			_003CGetHorizontalDisplacementAt_003Ec__AnonStorey.result.x = _003CGetHorizontalDisplacementAt_003Ec__AnonStorey.result.x * num2;
			_003CGetHorizontalDisplacementAt_003Ec__AnonStorey.result.y = _003CGetHorizontalDisplacementAt_003Ec__AnonStorey.result.y * num2;
			return _003CGetHorizontalDisplacementAt_003Ec__AnonStorey.result;
		}

		public Vector4 GetForceAndHeightAt(float x, float z, float spectrumStart, float spectrumEnd, float time)
		{
			_003CGetForceAndHeightAt_003Ec__AnonStorey2 _003CGetForceAndHeightAt_003Ec__AnonStorey = new _003CGetForceAndHeightAt_003Ec__AnonStorey2();
			_003CGetForceAndHeightAt_003Ec__AnonStorey.x = x;
			_003CGetForceAndHeightAt_003Ec__AnonStorey.z = z;
			_003CGetForceAndHeightAt_003Ec__AnonStorey.time = time;
			_003CGetForceAndHeightAt_003Ec__AnonStorey.result = default(Vector4);
			_003CGetForceAndHeightAt_003Ec__AnonStorey.x = 0f - (_003CGetForceAndHeightAt_003Ec__AnonStorey.x + surfaceOffset.x);
			_003CGetForceAndHeightAt_003Ec__AnonStorey.z = 0f - (_003CGetForceAndHeightAt_003Ec__AnonStorey.z + surfaceOffset.y);
			if (spectrumStart == 0f)
			{
				for (int num = numTiles - 1; num >= 0; num--)
				{
					if (tileSpectra[num].resolveByFFT)
					{
						...
						lock (tileSpectra[num])
						{
							InterpolationParams(_003CGetForceAndHeightAt_003Ec__AnonStorey.x, _003CGetForceAndHeightAt_003Ec__AnonStorey.z, num, windWaves.TileSizes[num], out fx, out invFx, out fy, out invFy, out index, out index2, out index3, out index4);
							Vector2[] da;
							Vector2[] db;
							tileSpectra[num].GetResults(_003CGetForceAndHeightAt_003Ec__AnonStorey.time, out da, out db, out fa, out fb, out p);
						}
						_003CGetForceAndHeightAt_003Ec__AnonStorey.result += FastMath.Interpolate(fa[index], fa[index2], fa[index3], fa[index4], fb[index], fb[index2], fb[index3], fb[index4], fx, invFx, fy, invFy, p);
					}
				}
			}
			if (filteredCpuWavesCount != 0)
			{
				SampleWavesDirectly(spectrumStart, spectrumEnd, _003CGetForceAndHeightAt_003Ec__AnonStorey._003C_003Em__0);
			}
			float num2 = water.HorizontalDisplacementScale * uniformWaterScale;
			_003CGetForceAndHeightAt_003Ec__AnonStorey.result.x = _003CGetForceAndHeightAt_003Ec__AnonStorey.result.x * num2;
			_003CGetForceAndHeightAt_003Ec__AnonStorey.result.z = _003CGetForceAndHeightAt_003Ec__AnonStorey.result.z * num2;
			_003CGetForceAndHeightAt_003Ec__AnonStorey.result.y *= 0.5f * uniformWaterScale;
			_003CGetForceAndHeightAt_003Ec__AnonStorey.result.w *= uniformWaterScale;
			return _003CGetForceAndHeightAt_003Ec__AnonStorey.result;
		}

		public float GetHeightAt(float x, float z, float spectrumStart, float spectrumEnd, float time)
		{
			_003CGetHeightAt_003Ec__AnonStorey3 _003CGetHeightAt_003Ec__AnonStorey = new _003CGetHeightAt_003Ec__AnonStorey3();
			_003CGetHeightAt_003Ec__AnonStorey.x = x;
			_003CGetHeightAt_003Ec__AnonStorey.z = z;
			_003CGetHeightAt_003Ec__AnonStorey.time = time;
			_003CGetHeightAt_003Ec__AnonStorey.result = 0f;
			_003CGetHeightAt_003Ec__AnonStorey.x = 0f - (_003CGetHeightAt_003Ec__AnonStorey.x + surfaceOffset.x);
			_003CGetHeightAt_003Ec__AnonStorey.z = 0f - (_003CGetHeightAt_003Ec__AnonStorey.z + surfaceOffset.y);
			if (spectrumStart == 0f)
			{
				for (int num = numTiles - 1; num >= 0; num--)
				{
					if (tileSpectra[num].resolveByFFT)
					{
						...
						lock (tileSpectra[num])
						{
							InterpolationParams(_003CGetHeightAt_003Ec__AnonStorey.x, _003CGetHeightAt_003Ec__AnonStorey.z, num, windWaves.TileSizes[num], out fx, out invFx, out fy, out invFy, out index, out index2, out index3, out index4);
							Vector2[] da;
							Vector2[] db;
							tileSpectra[num].GetResults(_003CGetHeightAt_003Ec__AnonStorey.time, out da, out db, out fa, out fb, out p);
						}
						_003CGetHeightAt_003Ec__AnonStorey.result += FastMath.Interpolate(fa[index].w, fa[index2].w, fa[index3].w, fa[index4].w, fb[index].w, fb[index2].w, fb[index3].w, fb[index4].w, fx, invFx, fy, invFy, p);
					}
				}
			}
			if (filteredCpuWavesCount != 0)
			{
				SampleWavesDirectly(spectrumStart, spectrumEnd, _003CGetHeightAt_003Ec__AnonStorey._003C_003Em__0);
			}
			return _003CGetHeightAt_003Ec__AnonStorey.result * uniformWaterScale;
		}
		...
		private void SampleWavesDirectly(float spectrumStart, float spectrumEnd, Action<WaterWave[], int, int> func)
		{
			lock (this)
			{
				WaterWave[] arg = GetFilteredCpuWaves();
		...
		public GerstnerWave[] SelectShorelineWaves(int count, float angle, float coincidenceRange)
		{
			...
			{
				_003C_003Ef__am_0024cache0 = _003CSelectShorelineWaves_003Em__0;
			}
		...
		public GerstnerWave[] FindMostMeaningfulWaves(int count, bool mask)
		{
			...
			{
				_003C_003Ef__am_0024cache1 = _003CFindMostMeaningfulWaves_003Em__1;
			}
		...
		public Gerstner4[] FindGerstners(int count, bool mask)
		{
			...
			{
				_003C_003Ef__am_0024cache2 = _003CFindGerstners_003Em__2;
			}
		...
		[CompilerGenerated]
		private static int _003CSelectShorelineWaves_003Em__0(FoundWave a, FoundWave b)
		{
			return b.importance.CompareTo(a.importance);
		}

		[CompilerGenerated]
		private static int _003CFindMostMeaningfulWaves_003Em__1(FoundWave a, FoundWave b)
		{
			return b.importance.CompareTo(a.importance);
		}

		[CompilerGenerated]
		private static int _003CFindGerstners_003Em__2(FoundWave a, FoundWave b)
		{
			return b.importance.CompareTo(a.importance);
		}
	}
